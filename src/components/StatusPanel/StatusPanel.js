  ...
  return (
    <div className="bg-slate-400 px-6 py-10">
      ...
      <div className="bg-orange-100 rounded p-5 flex justify-between">
        <button onClick={() => handleBreakTime(10)} className="btn btn-primary btn-sm rounded-full">
          10M
        </button>
        <button onClick={() => handleBreakTime(15)} className="btn btn-primary btn-sm rounded-full">
          15M
        </button>
        <button onClick={() => handleBreakTime(20)} className="btn btn-primary btn-sm rounded-full">
          20M
        </button>
        <button onClick={() => handleBreakTime(25)} className="btn btn-primary btn-sm rounded-full">
          25M
        </button>
        <button onClick={() => handleBreakTime(30)} className="btn btn-primary btn-sm rounded-full">
          30M
        </button>
      </div>
      <div className="mt-8">
